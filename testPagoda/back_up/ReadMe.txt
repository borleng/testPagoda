========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet testPagoda
========================================================================

AppWizard a créé cette application testPagoda pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application testPagoda.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé testPagoda.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
